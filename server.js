...
app.post('/analyze', analyzeLimiter, upload.single('image'), async (req, res) => {
  ...
  try {
    ...
    const prompt = [
      ...
      '  CRITICAL: Read the FIRSTNAME carefully letter by letter. Common Mongolian name endings:',
      '  -цэцэг, -нүүр, -сүрэн, -баяр, -болд, -мөнх, -гэрэл, -наран, -өлзий, -сайхан',
      '  Do NOT confuse similar-looking syllables. Read exactly what is written.',
      '',
