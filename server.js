...
app.post('/analyze', analyzeLimiter, upload.single('image'), async (req, res) => {
  ...
  try {
    ...
    const prompt = [
      ...
      '  Example: "Алтайн урманхайн иргэд овгийн Баярсайхан овогтой Зэсэм УО88031756"',
      '  → name="Баярсайхан Зэсэм", register="УО88031756"',
      '',
      'PATTERN B - "овгийн" with two name words:',
      '  "[CLAN] овгийн [SURNAME] [FIRSTNAME] [REGISTER]"',
      '  Take the TWO words after "овгийн" as Surname+Firstname.',
      '  Example: "Дайдал овгийн Болдбаатар Солонго УЛ087061526"',
      '  → name="Болдбаатар Солонго", register="УЛ087061526"',
      '',
      ...
      '  Example full text: "Дайдал овгийн Болдбаатар Солонго УЛ087061526, Шаравд овгийн Доржсүрэн Батзаяа ИЦ88022819 /хоёр иргэний өмч/"',
      '  → name="Болдбаатар Солонго", register="УЛ087061526", name2="Доржсүрэн Батзаяа", register2="ИЦ88022819", ownerCount="2"',
      '',
      'register format: 2 Cyrillic letters + 8 digits. Examples: УЛ087061526→УЛ08706152(8 digits), ИЦ88022819',
      'address: Full address with дүүрэг/хороо/байр/тоот.',
      'area: Number + м.кв before "талбайтай". Example: "51 м.кв", "45.71 м.кв"',
      'cert: Near "бүртгэж гэрчилгээ олгов". Starts with Ү-,Э-,Г-,Y-,V-. Example: Y-2204099086',
      '',
      'purpose: Find the property purpose/type in the certificate.',
      '  TYPE A (үл хөдлөх): Look for text before "зориулалттай". Extract the purpose description.',
      '  Examples: "Орон сууцны зориулалттай" → purpose="Орон сууцны зориулалттай"',
      '            "Оффисын зориулалттай" → purpose="Оффисын зориулалттай"',
      '            "Үйлчилгээний зориулалттай" → purpose="Үйлчилгээний зориулалттай"',
      '  TYPE B (газар): Look for text before "зориулалтаар". This describes land use.',
      ...
      '  If both "хашааны газар" and "зориулалтаар" appear together, it is land type.',
      '',
